...
class AppColors {
  ...
  static const Color error = Color.fromARGB(255, 238, 81, 81);
  ...
  static const Color textDeemed = Color(0xFFE0E0E0);
  static const Color textSecondary = Color(0xFFa3a3a3);
  static const Color border = Color(0xFFF4F7E4);
  static const Color white = Color(0xFFFFFFFF);
  static const Color hintText = Color(0xFF707070);
}
